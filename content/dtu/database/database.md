...
De data du kommer til at abejde med vil i mange tilfælde ligge i en Database.

Du kan enten tilgå dem direkte eller ved at data er eksporteret ud af databasen, f.eks. som en eller flere CSV filer.

For at arbejde effektiv med data er det nøvendigt at forstå hvordan en database er opbytte - Hvordan de forskellige tabeller "hænger" sammen og hvordan man kan kominere data fra flere forskellige tabeller.

## Database program
Det er databasen MySQL vi skal bruge.
For at gøre det simple brugere vi en online version af phpMyAdmin der er et program til administration af MySQL server.

[phpMyAdmin](https://www.phpmyadmin.net/try) 

Ulempen ved at bruge denne online version er at du ikke kan gemme. Fordelen er du ikke skal installere noget.
...
![ER_Northwind](/images/ER_Northwind.png)
...
![Skole_NF0](/images/Skole_NF0.png)

*Hvad er problemet?*

**NF 1**

![Skole_NF1](/images/Skole_NF1.png)

**NF 2**

![Skole_NF2](/images/Skole_NF2.png)

**NF 3**

![Skole_NF3](/images/Skole_NF3.png)
...
![EnTilMangeRelation](/images/EnTilMangeRelation.png)
...
![EnTilRelation](/images/EnTilRelation.png)
...
![MangeTilMangeRelation](/images/MangeTilMangeRelation.png)
